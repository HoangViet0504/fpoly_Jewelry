                  ...
                  >
                    ...
                    >
                      ...
                      <div className="mt-1 flex items-center">
                        <ChangeImage
                          imageUrl={formik.values.image_categories}
                          setImageUrl={(url) =>
                            formik.setFieldValue("image_categories", url)
                          }
                        />
                      </div>
                    </div>
                          ...
                          <div className=" mt-2.5 flex flex-row items-center gap-6">
                            <div className="flex items-center">
                              <input
                                ...
                                type="radio"
                                value="collection"
                                checked={formik.values.type === "collection"}
                                onChange={formik.handleChange}
                            ...
                            <div className="flex items-center">
                              <input
                                ...
                                type="radio"
                                value="category"
                                checked={formik.values.type === "category"}
                                onChange={formik.handleChange}
                                className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300"
                              />
                              <label
